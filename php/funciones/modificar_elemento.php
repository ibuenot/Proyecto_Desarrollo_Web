  ...
  <body>
    <nav class='navbar navbar-expand-lg navbar-light bg-light'>
      ...
      <form action="#" method="POST" enctype="multipart/form-data">
        ...
        <?php
        $conexion = ConectarBD();
        $consulta = "SELECT DISTINCT tipo FROM elementos";
...
if (isset($_POST['enviar'])) {
    ...
    $elemento->modificar_elemento($id_elemento,$foto,$nombre,$categoria,$descripcion,$autor,$fecha,$plataforma,$tipo,$activo);
...
<a href = '../admin/panel_administrador.php'> Volver atrás </a>
<br>
<br>
<br>
<br>
